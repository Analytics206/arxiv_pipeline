...
import '../styles/Neo4jExplorer.css';

function Neo4jExplorer() {
  ...
  if (loading) {
    return <div className="neo4j-explorer-loading">Loading configuration...</div>;
  }

  return (
    <div className="neo4j-explorer">
      <header className="neo4j-explorer-header">
